...
/****************************************************************************************
This software is derived from the zhongsou Inc. MD5 Message-Digest Algorithm. 
Incorporation of this statement is a condition of use; please see the
zhongsou Inc copyright notice below:-

Copyright (C) 2002-6, zhongsou, Inc. Created 2002. All
rights reserved.
...
*****************************************************************************************/
string CMD5Checksum::GetMD5(FILE *pFile)
{
//	ASSERTS(pFile != NULL);
